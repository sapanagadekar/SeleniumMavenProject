	 ...
	 public String  SearchResult(String OrderText) {
		// String SearchResultArray [] = new String [2];
		 ...
		 String s = OrderText;
			...
			TakeScreenshots.CaptureScreenshots(driver, "TC004_"+ String.format("%02d",  Constants.ScreenShotNum)  + "_Search Result_" + OrderText); 
		 ...
		 System.out.println("Select Filter");
			// String SearchResultArray [] = new String [2];
			 ...
			 for (int i = 0; i < Filter.length(); i++) {
				...
				//System.out.println(String.format("%02d",  Constants.ScreenShotNum));
				TakeScreenshots.CaptureScreenshots(driver, "TC005_"+ String.format("%02d",  Constants.ScreenShotfilterNum)  + "_Filter Result_" + Filter); 
